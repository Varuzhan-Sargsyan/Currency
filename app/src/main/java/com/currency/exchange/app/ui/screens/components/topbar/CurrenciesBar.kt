...
import com.currency.exchange.app.ui.theme.Dimensions.clickableIconSize
...
@Composable
fun CurrenciesBar(onClick: OnClick) {
    TopAppBar(
        modifier = Modifier
            .fillMaxWidth()
            .wrapContentHeight(),
            ...
            Row(
                ...
                Icon(
                    ...
                    modifier = Modifier.iconModifier(
                        iconSize = clickableIconSize,
                        iconPadding = iconPadding
                    ).clickable { onClick() }
                )
                Spacer(modifier = Modifier.width(paddingSmall))
                Text(
                    text = stringResource(R.string.title_currencies),
                    modifier = Modifier
                        .weight(1f)
